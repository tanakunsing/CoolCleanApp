...
function Profile() {
  ...
  const handlerinsertdata =(e,num)=>{
   console.log("Ysess");
   navigation(`/FormProduct`);
  }
  
  const handlerinsertdataStaff =(e,num)=>{
   console.log("Ysess");
                                    ...
                                    <div className="col">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <button class="btn btn-primary mt-2" onClick={(e =>{handlerinsertdata("sd")})}>เพิ่มบริการ</button>
                                            </div>
                                            <div class="col-lg-8">
                                                <div class="card mb-4">
                                                    <div class="card-body">
                                                ...
                                                <button class="btn btn-primary" onClick={(e =>{handlerinsertdataStaff("sd")})}>เพิ่มพนักงาน</button>
